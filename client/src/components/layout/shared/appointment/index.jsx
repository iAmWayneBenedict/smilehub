							...
							<div className="flex flex-col">
								<div className="flex flex-row gap-3 mt-5">
									...
									>
										...
										<h3 className="text-[#2F80ED] text-center uppercase font-medium mt-2 text-lg">
											Practitioner
										</h3>
										<h4>John Doe</h4>
									...
									>
										...
										<h4 className="text-center">Mololos, Bulacan</h4>
									</div>
								</div>
								...
								>
									<div className="flex flex-col items-start sm:items-center sm:flex-row">
										...
										<div style={{ flex: 2 }} className="w-full sm:w-fit">
											<Controller
												name="PATIENT_ID"
												control={control}
									...
									<div className="mt-10">
										<div className="flex gap-4">
											...
											<div>
												<h5 className="font-bold">Send notifications</h5>
											</div>
										</div>
										<div>
